...
> This post is totally not my style of writing, it was in fact written with an AI, I fed my idea and asked a dumb bot to regurgitate it in a style that was most suited for the story, it's not my style, it chose Kafka ironically. This is that version, the original version which will forever remain an AI artifact.