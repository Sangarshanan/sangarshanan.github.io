...
This blog is a spinoff from my ML assignment to build an AutoEncoder with the MagnaTagaTune Dataset <https://github.com/MTG/machine_learning_for_sound_and_music_25/blob/main/notebooks/06_01_autoencoders.ipynb> I tried to adapt the implementation to build a VAE and learn more about it in the process.
