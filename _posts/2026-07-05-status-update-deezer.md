...
Of course when we get into specifics there are transformers giving us state of the art recommendations for sequential recommendation where we care about order of interactions and people do use LLMs to make up for lost reasoning sprinkled with hallucinations of course but the fact is the industry is still running on linear algebra and somehow this really makes me happy.

> My research at Deezer has been focused on embedding aggregation, the stability of centroids & I have also been exploring alternate representations and the Geometry of SVD. Hopefully I will write about this after a long hard rumination session that is due post my intern days in Paris. Until then I run back to buying baguettes.
