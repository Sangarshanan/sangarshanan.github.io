...
This can be written based on a very simple property, here f and g are functions running an arbitrary operation #
...
There a lot of cool concepts involving category theory can be unpacked here, which you know very little/ nothing about so you just skeeted that whole dimension for this blog but I hope one day you learn more about it, some links about that 
