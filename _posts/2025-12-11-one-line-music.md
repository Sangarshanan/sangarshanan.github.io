...
I found this really cool [Bytebeats Beginner's Guide](https://github.com/TuesdayNightMachines/Bytebeats/blob/master/Bytebeats_Beginners_Guide_TTNM_v1-5.pdf) to get started with this tool. It explains what the mathematical and bitwise operators do, slowly building up to a step sequencer! It's also too much to just fuck around with the examples and make cool beats.
